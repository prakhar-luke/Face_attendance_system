...
class App:
    ...
    def login(self):
        label = test(
            ...
            model_dir="F:/Face_attendance_system/Silent-Face-Anti-Spoofing-master/resources/anti_spoof_models",
            device_id=0
            )
        if label == 1:
            name = util.recognize(self.most_recent_capture_arr, self.db_dir)
            if name in ['unknown_person', 'no_persons_found']:
                util.msg_box("Opse !!!", "Unknown User, Please register or try again")
            else:
            ...
            util.msg_box("Alert !!!", "Fake person ! ")
    ...
    def accept_register_new_user(self):
        ...
        util.msg_box('Success', 'User registered ')
        self.register_new_user_window.destroy()
